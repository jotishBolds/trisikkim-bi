...
interface StaffMember {
  ...
  name: string;
  position: string;
  translations?: { hi?: { name?: string; position?: string } } | null;
}
...
export default function WhosWhoPage() {
  ...
  // Helper to get translated name/position
  const tName = (s: StaffMember) =>
    (lang !== "en" && s.translations?.hi?.name) || s.name;
  const tPosition = (s: StaffMember) =>
    (lang !== "en" && s.translations?.hi?.position) || s.position;
    ...
    <div className="min-h-screen bg-[#f8f7fc] font-body">
          ...
          >
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-[11px] font-bold uppercase tracking-[.18em] text-[#f4c430]">
                {dict.nav.about} / {dict.whosWho.title}
              </span>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8 py-3">
          <div className="relative max-w-sm">
            ...
            <input
              ...
              placeholder={dict.whosWho.searchPlaceholder}
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-12">
        ...
        {filtered.length > 0 && (
          ...
          >
            Showing {filtered.length} {dict.common.of} {staffList.length}
          </motion.p>
        )}
      </div>
    </div>

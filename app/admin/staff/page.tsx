          ...
          <table className="w-full text-xs">
            <thead>
              <tr className="bg-[#1077a6] text-white">
                ...
                <th className="px-3 py-2.5 text-left font-semibold hidden xl:table-cell">
                  Phone
                </th>
            ...
            <tbody>
                ...
                {items.map((item, i) => (
                  ...
                  >
                    ...
                    <td className="px-3 py-2.5">
                      <p className="font-semibold text-[#1a1550]">
                        {item.name}
                      </p>
                    ...
                    <td className="px-3 py-2.5 text-[#1a1550]/40 hidden xl:table-cell">
                      {item.phone || (
                        <span className="text-[#1a1550]/20 italic">—</span>
                      )}
                    </td>
              ...
              {items.length === 0 && (
                <tr>
                  ...
                  >
                    No {activeTab === "officer" ? "officers" : "staff"} yet.
